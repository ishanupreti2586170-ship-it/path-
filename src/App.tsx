...
const QUESTIONS = [
    ...
    opts: [
      {
        v: "analytical",
        l: "42",
        s: "I spotted the pattern: differences are +4, +6, +8, +10, +12",
      },
      {
        v: "intuitive",
        l: "40",
        s: "It felt like it should jump by roughly 10 again",
      },
      {
        v: "systematic",
        l: "36",
        s: "I assumed it was multiplying or adding a fixed number",
      },
      {
        v: "creative",
        l: "I didn't try to calculate — I just guessed",
        s: "Numbers aren't my natural language",
      },
    ],
  },
  {
    ...
    opts: [
      {
        v: "systems",
        l: "The road network — how it all connects",
        s: "I want to understand the flow and logic of movement",
      },
      {
        v: "spatial",
        l: "The overall shape and layout from above",
        s: "I'm drawn to the big picture and visual structure",
      },
      {
        v: "human",
        l: "Where people live — residential areas, density",
        s: "I'm most interested in the human side of the place",
      },
      {
        v: "detail",
        l: "Specific landmarks or points of interest",
        s: "I zoom into particular things rather than the whole",
      },
      {
        v: "strategic",
        l: "Entry and exit points — how you get in and out",
        s: "I instinctively think about access and efficiency",
      },
    ],
  },
  {
    ...
    opts: [
      {
        v: "analytical",
        l: "5 cents — I worked it out carefully",
        s: "bat=$1.05, ball=$0.05 — the algebra checks out",
      },
      {
        v: "impulsive",
        l: "10 cents — that was my first thought",
        s: "Most people jump to this; I know it feels right but isn't",
      },
      {
        v: "uncertain",
        l: "I'm not sure — I second-guessed myself",
        s: "I knew something was off but couldn't pin it down",
      },
      {
        v: "skipped",
        l: "I didn't try to solve it",
        s: "Math puzzles aren't where my mind naturally goes",
      },
    ],
  },
  {
    ...
    opts: [
      {
        v: "analogy",
        l: "Find a completely different analogy or metaphor",
        s: "If one comparison doesn't work, I'll find another angle",
      },
      {
        v: "breakdown",
        l: "Break it into even smaller pieces and go slower",
        s: "The structure was right — they just need more steps",
      },
      {
        v: "visual",
        l: "Draw it, sketch it, or use hand gestures",
        s: "I instinctively go spatial when words fail",
      },
      {
        v: "question",
        l: "Ask what part they're stuck on and start there",
        s: "I diagnose where the gap is before trying again",
      },
      {
        v: "surrender",
        l: "Accept that it's hard to explain and move on",
        s: "Some things just resist explanation",
      },
    ],
  },
  {
    ...
    opts: [
      {
        v: "invest_self",
        l: "Put it all into a skill, course, or tool",
        s: "Best ROI is investing in your own capability",
      },
      {
        v: "invest_money",
        l: "Put it in something that can grow — stocks, crypto, assets",
        s: "Money should work for you, not sit idle",
      },
      {
        v: "build",
        l: "Use it to build or launch something small",
        s: "Even $1,000 can start something real",
      },
      {
        v: "experience",
        l: "Spend it on travel or a life-changing experience",
        s: "Experiences compound in ways money can't",
      },
      {
        v: "save",
        l: "Save it — security matters more than growth right now",
        s: "A cushion is the foundation of everything else",
      },
    ],
  },
  {
    ...
    opts: [
      {
        v: "rules",
        l: "Most rules exist for good reasons and should be followed",
        s: "Systems work when people respect the structure",
      },
      {
        v: "context",
        l: "Rules depend on context — some deserve to be broken",
        s: "Judgment matters more than blind compliance",
      },
      {
        v: "change",
        l: "Most systems are outdated and need to be rebuilt",
        s: "The status quo isn't sacred — it should be challenged",
      },
      {
        v: "people",
        l: "Rules matter less than the relationships they affect",
        s: "How people feel always outweighs the letter of the law",
      },
    ],
  },
  {
    id: "q7",
    section: "How You See the World",
    ...
    items: [
      {
        v: "tech",
        l: "How things work — engineering, science, tech breakdowns",
      },
      {
        v: "people",
        l: "Human stories — real life, psychology, relationships",
      },
      { v: "numbers", l: "Data, statistics, trends, financial patterns" },
      { v: "ideas", l: "Big ideas — philosophy, futures, theories" },
      {
        v: "making",
        l: "Process of making things — from concept to finished result",
      },
  ...
  },
  {
    ...
    opts: [
      {
        v: "data",
        l: "I'd want to see the data broken down by product, region, time",
        s: "The aggregate number tells me nothing — I need the breakdown",
      },
      {
        v: "cause",
        l: "Something external changed — market, competition, news",
        s: "A sudden drop usually means something outside shifted",
      },
      {
        v: "internal",
        l: "Something broke internally — team, product, process",
        s: "Most crises start from within, not outside",
      },
      {
        v: "people",
        l: "Who's been affected and how are they holding up?",
        s: "The human impact is the most urgent thing to understand",
      },
      {
        v: "opportunity",
        l: "This might actually be a reset opportunity",
        s: "Disruption opens doors that stability keeps closed",
      },
    ],
  },
  {
    ...
    opts: [
      {
        v: "science",
        l: "Why do we sleep — and what exactly happens in our brain?",
        s: "The biological machinery of consciousness and rest",
      },
      {
        v: "social",
        l: "Why do some societies thrive and others collapse?",
        s: "The patterns behind civilizational success and failure",
      },
      {
        v: "tech",
        l: "Will artificial intelligence ever be truly conscious?",
        s: "The line between simulation and genuine experience",
      },
      {
        v: "personal",
        l: "Why do people make self-destructive choices they can't stop?",
        s: "The gap between knowing and doing in human behaviour",
      },
      {
        v: "universe",
        l: "Is there life somewhere else in the universe?",
        s: "The statistical near-certainty and total silence of space",
      },
    ],
  },
  {
    id: "q10",
    section: "Decisions & Risk",
    ...
    opts: [
      {
        v: "risk_high",
        l: "Job B without much hesitation",
        s: "Upside matters more than security — I back myself",
      },
      {
        v: "risk_calc",
        l: "Job B, but only after serious due diligence",
        s: "I need to believe in the upside before betting on it",
      },
      {
        v: "risk_low",
        l: "Job A — the stability is genuinely worth more to me",
        s: "A reliable foundation lets me take other risks in life",
      },
      {
        v: "risk_context",
        l: "It depends entirely on what the job actually is",
        s: "The work itself matters more than the pay structure",
      },
    ],
  },
  {
    ...
    opts: [
      {
        v: "pivot",
        l: "Scrap it and restart fresh — clean slate is faster",
        s: "Sunk cost is a trap; the new path is always cleaner",
      },
      {
        v: "adapt",
        l: "Adapt what I have — salvage the good parts",
        s: "Not everything needs to go; I look for what's still useful",
      },
      {
        v: "push",
        l: "Finish it anyway — quitting mid-way feels wrong",
        s: "Completion has its own value even when imperfect",
      },
      {
        v: "consult",
        l: "Pause and get a second opinion before deciding",
        s: "Another perspective might see options I'm missing",
      },
      {
        v: "learn",
        l: "Figure out first how I got the approach wrong",
        s: "Understanding the error matters before fixing anything",
      },
    ],
  },
  {
    ...
    opts: [
      {
        v: "builder",
        l: "I built something real that exists in the world",
        s: "A company, product, body of work — something tangible that outlasts me",
      },
      {
        v: "expert",
        l: "I became one of the best in the world at something specific",
        s: "Depth of mastery and undeniable expertise in my field",
      },
      {
        v: "free",
        l: "I answer to no one and go where I want",
        s: "Complete financial and geographic freedom — life entirely on my terms",
      },
      {
        v: "impact",
        l: "I changed how people think or live in a meaningful way",
        s: "Real-world impact that improved lives, not just my own",
      },
      {
        v: "known",
        l: "People in my field or beyond know who I am",
        s: "A name that carries weight, a reputation that opens doors",
      },
    ],
  },
];
      ...
      <AnimatePresence mode="wait">
        {screen === "welcome" && (
          ...
          >
            ...
            <p className="welcome-sub text-sm text-[var(--mist)] leading-relaxed max-w-md mx-auto mb-10">
              A deep personality assessment that maps your mind, reveals your
              ideal professions, tests your aptitude, and gives you an exact
              ...
              {QUESTIONS[step].type === "single" ? (
                ...
                <div className="star-items flex flex-col gap-3">
                  {QUESTIONS[step].items?.map((it) => (
                    <div
                      key={it.v}
                      className="star-row flex items-center justify-between p-3 glass"
                    >
        ...
        {screen === "report" && (
          ...
          >
            ...
            <div className="orn w-full my-10">
              <div className="orn-l" />
              <span className="orn-c">RECOMMENDATIONS</span>
              <div className="orn-r" />
            </div>
                ...
                <div
                  ...
                  onClick={() => {
                    if (selectedCareers.find((sc) => sc.title === c.title)) {
                      setSelectedCareers(
                        selectedCareers.filter((sc) => sc.title !== c.title),
                      );
                    } else {
            ...
            {selectedCareers.length === 2 && (
              ...
              >
                <div className="orn w-full my-6">
                  <div className="orn-l" />
                  <span className="orn-c">COMPARISON</span>
                  <div className="orn-r" />
                </div>
                  ...
                  {selectedCareers.map((c, i) => (
                    <div key={i} className="glass flex flex-col gap-3">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-[10px] text-[var(--gold-l)]">
                          {c.match}% Match
                        </span>
                      </div>
                      <div>
                        <p className="text-[9px] text-[var(--gold-d)] uppercase tracking-widest mb-1">
                          Why it fits
                        </p>
                        <p className="text-[11px] text-[rgba(240,234,255,0.7)] leading-relaxed">
                          {c.reason}
                        </p>
                      </div>
                      <div className="flex-1">
                        ...
                        <div className="flex flex-wrap gap-1.5">
                          {c.skills?.map((skill: string) => (
                            <span
                              key={skill}
                              className="text-[9px] px-2 py-0.5 rounded-full bg-[rgba(255,255,255,0.05)] border border-[rgba(201,168,76,0.1)] text-[var(--mist)]"
                            >
                              {skill}
                            </span>
                          ))}
            ...
            {selectedCareers.length === 1 && (
              <div className="flex flex-col items-center gap-4 mt-8">
                <p className="text-[11px] text-[var(--mist)] italic">
                  Select a second career to compare
                </p>
                <button
                  className="btn btn-primary"
                  onClick={() => startTest(selectedCareers[0])}
                >
            ...
            {selectedCareers.length === 0 && (
              <div className="flex flex-col items-center gap-4 mt-8">
                <p className="text-[11px] text-[var(--mist)] italic">
                  Select up to two careers from the list above
                </p>
              </div>
            )}
          </motion.div>
        ...
        {screen === "test-intro" && (
          ...
          >
            ...
            <h2 className="display text-4xl text-center mb-8">
              Likability &<br />
              <em className="text-[var(--gold-l)]">Readiness Test</em>
            </h2>
            ...
            <div className="card w-full text-center">
              ...
              <p className="text-sm text-[rgba(240,234,255,0.6)] leading-relaxed mb-8">
                The oracle has synthesized 5 specialized questions to probe your
                natural alignment with this profession. This covers logic,
                intuition, and domain judgment.
              </p>
              {testQuestions.length > 0 ? (
                <button
                  className="btn btn-primary w-full"
                  onClick={() => setScreen("test-question")}
                >
                  <span>Enter the Trials ✦</span>
                </button>
              ) : (
                <p className="oracle-status text-[10px] tracking-widest uppercase py-4">
                  Crafting your trial questions...
                </p>
              )}
            </div>
          </motion.div>
        ...
        {screen === "test-question" && (
          ...
          >
            <div className="progress-wrap mb-8">
              ...
              <div className="progress-track h-[2px] bg-[rgba(255,255,255,0.06)]">
                <motion.div
                  className="progress-fill h-full bg-gradient-to-r from-[var(--violet)] to-[var(--gold)]"
                  animate={{
                    width: `${(testStep / testQuestions.length) * 100}%`,
                  }}
                />
              </div>
            </div>
            ...
            <div className="card mb-10">
              <p className="eyebrow text-[var(--gold-d)] mb-4 tracking-tighter">
                Trial {testStep + 1} OF 5
              </p>
              <p className="q-text text-2xl font-light font-cg mb-6">
                ...
                {testQuestions[testStep].opts.map((opt: string, i: number) => {
                  ...
                  return (
                    <div
                      key={i}
                      className={cls}
                      onClick={() => !revealed && handleTestAnswer(i)}
                    >
                      <span className="opt-letter mr-2 text-[var(--gold-d)]">
                        0{i + 1}
                      </span>
                      {opt}
                    </div>
              ...
              {testQuestions[testStep].selectedIndex !== undefined && (
                ...
                >
                  <p className="text-xs text-[var(--teal)] leading-relaxed">
                    {testQuestions[testStep].explain}
                  </p>
                </motion.div>
              )}
            </div>
            ...
            <div className="btn-row flex justify-end">
              ...
              >
                <span>
                  {testStep === 4 ? "See Final Roadmap" : "Next Trial →"}
                </span>
              </button>
            </div>
          </motion.div>
            ...
            >
              <div className="text-center mb-10">
                ...
                <h2 className="display text-5xl">
                  Your Path
                  <br />
                  <em className="text-[var(--gold-l)]">Revealed</em>
                </h2>
              </div>
                ...
                <div className="relative w-40 h-40 mx-auto mb-8 flex items-center justify-center">
                  ...
                  >
                    ...
                    <motion.circle
                      ...
                      animate={{
                        strokeDashoffset:
                          283 - (283 * (finalReport?.readiness || 0)) / 100,
                      }}
              ...
              <div className="orn w-full my-8">
                <div className="orn-l" />
                <span className="orn-c">NEXT STEPS</span>
                <div className="orn-r" />
              </div>
              ...
              <div className="card text-left bg-[rgba(201,168,76,0.05)] border-[rgba(201,168,76,0.1)] mb-10">
                ...
                <div className="flex flex-col gap-3">
                  {finalReport?.improvements?.map((imp: string, i: number) => (
                    <div
                      key={i}
                      className="flex gap-2 text-xs text-[var(--mist)]"
                    >
              ...
              <div className="glass border-dashed border-[rgba(201,168,76,0.3)] text-center py-10 mb-10">
                ...
                <p className="display text-3xl text-[var(--gold-l)] mb-4">
                  {finalReport?.timeline}
                </p>
                <p className="text-sm text-[var(--mist)] italic max-w-sm mx-auto">
                  {finalReport?.timeline_detail}
                </p>
              </div>
            </div>
    ...
    <div className="pt-20 flex flex-col items-center text-center app w-full max-w-[720px] px-4 pb-20 relative z-10">
      ...
      <div className="card text-left mb-8 max-w-3xl">
        ...
        <p className="text-sm text-[rgba(240,234,255,0.7)] leading-relaxed mb-6">
          Career Oracle blends psychological profiling with artificial
          intelligence to suggest potential career paths. By analyzing your
          decision-making styles, curiosities, and risk tolerance, it attempts
          to align your personality with real-world professions.
        </p>
        <div className="orn w-full my-6">
          <div className="orn-l" />
          <span className="orn-c">✦</span>
        ...
        <p className="text-sm text-[rgba(240,234,255,0.7)] leading-relaxed">
          This website and its career recommendations are generated by an AI
          model for entertainment and exploratory purposes.{" "}
          <strong>This tool is not 100% reliable</strong> and should not be used
          as the sole basis for major life decisions, academic choices, or
          professional direction. Always consult with human career counselors,
          mentors, and rely on your own judgment.
        </p>
        ...
        <h1 className="text-xl text-[var(--gold-l)] mb-4 font-cg">
          The Ultimate Guide: How to Navigate Your Professional Future
        </h1>

        <div className="text-sm text-[rgba(240,234,255,0.7)] leading-relaxed space-y-4">
          <p>
            Are you constantly asking yourself, "what should i chose as a
            career?" or pondering "what am i good at?" Navigating the modern
            professional landscape can easily feel overwhelming. The pressure to
            make the perfect choice is immense. Whether you are a student
            starting fresh, a recent graduate entering the workforce, or a
            seasoned professional thinking, "i want to change my profession,"
            the journey to discover your true calling starts with deep
            self-awareness. At Career Oracle, we are entirely dedicated to
            helping you answer the most pivotal question of your professional
            life: how to find your career path? Our comprehensive tools are
            designed specifically to illuminate your optimal professional
          ...
          <p>
            Before jumping headfirst into saturated job markets, you must take
            the time to turn inward. To truly find compatible job for me, I
            first need to understand my brain capability and intrinsic talents.
            What I can do often differs drastically from what I actually enjoy
            doing on a daily basis. When you ask yourself, "how can i chose my
            job?", the fundamental answer lies in meticulously mapping out your
            core strengths, passions, and risk tolerance. Our intelligent system
            acts as a multifaceted test to find career path options that align
            perfectly with your unique cognitive and emotional footprint. It's
            not just about what you know theoretically; it's about uncovering
            exactly "what i can do to earn" a living while remaining genuinely
            fulfilled and driven. Evaluating my capabilities is the cornerstone
          ...
          <p>
            Countless individuals wonder, "how to find career path that matches
            my interests?" Traditional methods usually involve extensive trial
            and error, taking entry-level jobs just to test the waters. However,
            taking a structured quiz to find career path clarity can seamlessly
            condense years of exhausting soul-searching into a matter of
            minutes. Our AI-driven exploration tool carefully analyzes your
            responses to discover hidden patterns and inclinations you might
            have missed entirely. If you desperately need help find career path
            directions, this dynamic approach acts as your personal, highly
            objective compass. By accurately measuring my capabilities against
            real-world industry demands, we narrow down the confusing noise to
            present a focused, tailored, and highly actionable professional
            trajectory. Books to help find career path are great, but AI
            provides immediate personalization.
          </p>

          <h2 className="text-base text-[var(--gold)] mt-6 mb-2">
            Guidance for Everyone: From Teens to Career Changers
          </h2>
          <p>
            The quest to find a career path is universal. Parents frequently
            reach out to us asking, "how to help teen find career path?" The
            best advice is to encourage unpressured exploration, limit societal
            expectations, and utilize engaging tools that translate abstract
            adolescent interests into concrete, viable professional options.
            Beyond digital tools, continuous learning is essential. Whether you
            are a parent guiding a high schooler, or an adult realizing "what i
            can do" spans far beyond your current role, there are endless
            resources waiting to be leveraged. We act as a powerful career
            finder AI and career mapping tool free for all users.
          </p>

          <h2 className="text-base text-[var(--gold)] mt-6 mb-2">
            Taking the Final Step to Confidence
          </h2>
          <p>
            The journey to find your career path is rarely a perfectly straight
            line. Instead, it is a beautifully continuous process of discovering
            your evolving identity and adapting to entirely new opportunities.
            So, if you are currently stuck, deeply pondering how to find a
            career path that truly resonates with your inner self, remember that
            every great professional journey begins with a single, courageous
            step of self-discovery. Take control of your future, dive into our
            intuitive analysis, explore your personalized cosmic report, and
        ...
        <div className="text-sm text-[rgba(240,234,255,0.7)] leading-relaxed space-y-4">
          <h4 className="text-base text-[var(--gold)] mt-6 mb-2">
            What makes Career Oracle the best AI for career guidance?
          </h4>
          <p>
            Career Oracle uniquely blends advanced personality profiling with
            deep artificial intelligence insights, providing holistic
            recommendations rather than basic job title matching. It acts as an
            intuitive guide to align your core strengths with viable roles.
          </p>

          <h4 className="text-base text-[var(--gold)] mt-6 mb-2">
            Is there a best free AI for career guidance available?
          </h4>
          <p>
            Yes, our core platform operates as a versatile career mapping tool
            free of charge, allowing you to seamlessly uncover aligned
            professional avenues without needing an initial investment.
          </p>

          <h4 className="text-base text-[var(--gold)] mt-6 mb-2">
            How precise is your career prediction AI?
          </h4>
          <p>
            While our comprehensive models analyze vast amounts of data
            regarding psychological traits and modern job market trends, our
            career prediction AI should be used as an illuminating exploratory
            compass rather than an absolute, final verdict. always use your own
            judgment.
          </p>

          <h4 className="text-base text-[var(--gold)] mt-6 mb-2">
            How does a career finder AI actually work?
          </h4>
          <p>
            A career finder AI systematically evaluates your distinct
            preferences, stress responses, problem-solving methodologies, and
            natural affinities. It then meticulously cross-references this
            specific profile against thousands of contemporary industry roles to
            suggest the most harmonious professional matches.
          </p>

          <h4 className="text-base text-[var(--gold)] mt-6 mb-2">
            Is this tool suitable for career exploration for students?
          </h4>
          <p>
            Absolutely. High school and college individuals can effectively use
            this platform as a premier module for career exploration for
            students, laying a strong, fundamental foundation before prematurely
            committing to specific, rigid degrees or long-term training
            programs.
          </p>
        </div>
      </div>
